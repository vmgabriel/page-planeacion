...
### Mision Planteada
Ofrecer proteccion integral para asegurar la salud y proteccion en la poblacion afiliada incluyendo con personas caso de riesgo de vida.
...
### Vision Planteada
Nueva EPS se compromete a dar el mejor servicio de salud a nivel nacional, con el animo de dar nuestros servicios a nivel global, asegurando excelencia operacional, comprometidos con su entorno y su gestion transparente, siempre buscando procesos de mejora para su tecnica y tecnologia
...
## Análisis de Estructura Orgánica
### Estructura Organizacional Actual
![Organigrama Actual]({{ site.baseurl }}/img/organigrama2018.jpg "Organigrama Actual")

###Subsistemas
#### Subsitemas de Apoyo
![Apoyo]({{ site.baseurl }}/img/apoyo.png "Apoyo")

#### Subsistemas Directores o Gerenciales
![Directores]({{ site.baseurl }}/img/directores.png "Directores")

#### Subsistemas Tecnicos o de Produccion
![Produccion]({{ site.baseurl }}/img/produccion.png "Produccion")

#### Subsistemas de Adaptación
![Adaptacion]({{ site.baseurl }}/img/adaptacion.png "Adaptacion")

#### Subsistemas de Mantenimiento
![Mantenimiento]({{ site.baseurl }}/img/mantenimiento.png "Mantenimiento")
...
![Organigrama]({{ site.baseurl }}/img/juntaDirectiva.png "Organigrama")
